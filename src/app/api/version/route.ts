...
export async function GET(request: NextRequest) {
  // Base public response (Node.js version omitted as per security requirements)
  ...
  // Optional operator diagnostics for authenticated administrators only
  try {
    ...
    // Non-admin or unauthenticated: return standard public payload
  }
